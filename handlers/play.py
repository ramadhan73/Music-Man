                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nAtau tambahkan secara manual @Assistenmussicsantai_bot ke Grup Anda dan coba lagi</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    keyboard = InlineKeyboardMarkup(
            [   
                [
                    ...
                    InlineKeyboardButton("⛑ Group Support", url="https://t.me/wavyheartt")
                
                ],                     
                [
                    InlineKeyboardButton(
                        "Owner Music santai", url="https://t.me/gksukaribett"
                    )
                ],
                [       
                    InlineKeyboardButton(
...
async def deezer(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
            [   
                ...
                [
                    InlineKeyboardButton(
                        "Owner Mussic santai", url="https://t.me/gksukaribett"
                    )
                ],
                [       
                    InlineKeyboardButton(
